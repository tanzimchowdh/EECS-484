CREATE TABLE USERS(
  USER_ID NUMBER PRIMARY KEY ON DELETE CASCADE,
...
CREATE TABLE CITIES(
  CITY_ID INTEGER PRIMARY KEY ON DELETE CASCADE,
...
CREATE TABLE PROGRAMS(
  PROGRAM_ID INTEGER PRIMARY KEY ON DELETE CASCADE,
...
CREATE TABLE ALBUMS(
  ALBUM_ID NUMBER PRIMARY KEY ON DELETE CASCADE,
  ...
  CHECK (ALBUM_VISIBILITY IN ('EVERYONE', 'FRIENDS', 'FRIENDS_OF_FIRENDS', 'MYSELF')),
  FOREIGN KEY (ALBUM_OWNER_ID) REFERENCES USERS(USER_ID) ON DELETE CASCADE
);

CREATE TABLE PHOTOS(
  PHOTO_ID NUMBER PRIMARY KEY ON DELETE CASCADE,
...
ALTER TABLE ALBUMS
  ADD CONSTRAINT COVER_PHOTO FOREIGN KEY (COVER_PHOTO_ID) REFERENCES PHOTOS(PHOTO_ID);